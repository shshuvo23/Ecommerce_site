                        ...
                        <table class="table axil-product-table axil-cart-table mb--40">
                            ...
                            <tbody>
                                @foreach ($carts as $cart)
                                    <tr>
                                        <td class="product-remove"><a href="{{ route('cart.delete', ['id' => $cart->id]) }}"
                                                class="remove-wishlist"><i class="fal fa-times"></i></a></td>
                                        <td class="product-thumbnail"><a href="single-product.html"><img
                                                    src="{{ asset($cart->product->image) }}" alt="Digital Product"></a></td>
                                        ...
                                        <td class="product-price" data-title="Price"><span
                                                class="currency-symbol">$</span>{{ $cart->product->price }}</td>
                                        ...
                                        <td class="product-subtotal" data-title="Subtotal"><span
                                                class="currency-symbol">$</span>{{ $cart->product->price * $cart->quantity }}
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                                        ...
                                        <table class="table summery-table mb--30">
                                            <tbody>
                                                <tr class="order-subtotal">
                                                    <td>Subtotal</td>
                                                    <td>{{ $carts->sum(function ($cart) {return $cart->product->price * $cart->quantity;}) }}
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="order-total">
                                                    ...
                                                    <td class="order-total-amount">
                                                        {{ $carts->sum(function ($cart) {return $cart->product->price * $cart->quantity;}) }}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
